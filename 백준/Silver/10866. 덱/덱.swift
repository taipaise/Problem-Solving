...
for _ in 0..<n {
    ...
    case Operation.push_front.rawValue:
        queue.pushFirst(Int(str_arr.last!)!)
    case Operation.push_back.rawValue:
        queue.pushLast(Int(str_arr.last!)!)
    case Operation.pop_front.rawValue:
        res = queue.popFirst()
        if let res = res {
            print(res)
        } else {
    ...
    case Operation.pop_back.rawValue:
        res = queue.popLast()
        if let res = res {
            print(res)
        } else {
